...
var ProjectItem = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ProjectItem.prototype, "persons", {
        get: function () {
            if ((this.project.people >= 2 && this.project.people <= 4) ||
...
var ProjectList = /** @class */ (function (_super) {
    ...
    function ProjectList(type) {
        ...
        _this.configure(); //these two methods are called here because if we call them in base class we could face some problems if methods in inheriting class rely on a certain properties which are not set yet. It's "safer" doing it this way.
        _this.renderContent();
        return _this;
    }
    ...
    ProjectList.prototype.dragDropHandler = function (event) {
    ...
    ProjectList.prototype.configure = function () {
        ...
        projectState.addListener(function (projects) {
            ...
            _this.renderProjects(); // this func will be call later - AFTER this.attach(); and this.renderContent();
        });
    };
    ...
    __decorate([
        autobind
    ], ProjectList.prototype, "dragDropHandler");
    __decorate([
        autobind
